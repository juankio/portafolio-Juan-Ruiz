...
.nav-brand__icon {
  ...
  box-shadow: 2px 3px 0 rgba(0,0,0,0.3), 0 0 0 0 var(--color-accent);
  transition: all 0.2s var(--ease-spring);
}

.group:hover .nav-brand__icon {
  box-shadow: 3px 4px 0 rgba(0,0,0,0.25), 0 0 12px var(--color-accent-soft);
}
</style>
